  ...
  <body class="index">
    <div class="header">
      <img src="TheNigelProductionText.png" alt="logo" class="logo">
        <a href="buymerch.php" class="linker" >Buy Merch</a> <a href="SignIN.php" class="linker">Join The Community</a>
        ...
        </a> <div class="container" onclick="myFunction(this)">
  <div class="bar1"></div>
  <div class="bar2"></div>
  <div class="bar3"></div>
</div>
    ...
    <div class="drop" id="drop">
      <a href="#">Options</a><br><br>
      <a href="#">Contact</a><br><br>
      <a href="#">About</a><br><br>
      <a href="briefQnA.html">Brief QnA</a><br><br>
      <a href="yourprofilepage.php">Profile</a><br>
      <h3>YOUTUBE VIDEOS</h3>
      <a href="https://www.youtube.com/watch?v=cWwlT4lfetA"><Img src="https://i.ytimg.com/vi/cWwlT4lfetA/hqdefault.jpg?sqp=-oaymwEZCPYBEIoBSFXyq4qpAwsIARUAAIhCGAFwAQ==&rs=AOn4CLDGk5eARn_2RU40PR3kCEa-LM0uQw"</img></a>
      <p>GTA 6 But Better</p><br>
      ...
      <p>3rd MCU Spiderman Sequel (a bad sequel)</p><br>
    </div>
