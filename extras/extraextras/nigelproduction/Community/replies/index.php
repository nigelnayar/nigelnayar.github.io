...
{
  $hash = "/#+([a-zA-Z0-9_]+)/";
  $tag = preg_replace($hash, '<a style= "text-decoration: underline;" href="\Community/asdf.php?tag=$1">$0</a>', $tag);
  return($tag);
}
...
<body>
  <?php while ($pos = mysqli_fetch_array($check)) {
    ...
    echo "<img src='\Community/$ppic' style= 'width:60px; height: 60px; position: relative; border-radius: 50px; '>";
    echo "<span style='display: inline-block; padding-left: 10px;  '>";
    echo "<h3>";
    echo "<a href= '\Community/$name'>";
    echo $name;
    echo "</a>";
    echo "</h3>";
    ...
    echo "<br>";
      ...
      echo "<br>";
              ...
              $replies = mysqli_query($conn, "SELECT * FROM replies WHERE postid = '".$po. "'");
       ?>
       <br><br><br>
       <div class="">
        ...
        <?php
          ...
          if (mysqli_num_rows($replies) < 1) {
            ...
            while ($re = mysqli_fetch_array($replies)) {
              ...
              echo "<img src='\Community/$ppic' alt='' class='homepp'>";
              echo "<span id='$rid' class='getinf'>";
              echo "<a href= '\Community/$usern'>";
              echo $usern ;
              echo " ";
              echo "</a>";
              echo "</span>";
       ...
       <script type="text/javascript" src="\Community/script.js">
