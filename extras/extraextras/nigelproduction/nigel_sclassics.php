...
session_start();
      ...
      <div class="drop" id="drop">
        ...
        <label>3rd MCU Spiderman Sequel (a bad sequel)</label><br>
          ...
          <div class="mobilemenu">
            <br>
              ...
              <a href="#" >Join The Community</a><br><br>
          ...
          <div class="toptext">
            ...
            <label>Click On The Title To start downloading</label><br><br><br><br>
        ...
        <br><br><br><br><br><br><br>
          ...
          <div class="mySlides fade">
            ...
            <video width="100%" height="377" poster="Perang.jpeg" controls>
              <source src="Perang1.mp4"  type="video/mp4">
              Your browser does not support HTML video.
            </video>
            <div class="text">Perang Lapangan Pertama</div>
          </div>

          <div class="mySlides fade">
            <div class="numbertext">2 / 5</div>
            <video width="100%" poster="Santa.jpeg" controls>
              <source src="IsSantaReal.mp4" type="video/mp4">
              Your browser does not support HTML video.
            </video>
            <div class="text">Is Santa Real? (Indonesian)</div>
          </div>
          ...
          <div class="mySlides fade">
            ...
            <div class="text">Just A Walking Animation</div>
          </div>

          <div class="mySlides fade">
            <div class="numbertext">4 / 5</div>
            <video width="100%" height="377" poster="DonUji.jpeg" controls>
              <source src="DonUji.mp4"  type="video/mp4">
              Your browser does not support HTML video.
            </video>
            <div class="text">Don Uji Nyali</div>
          </div>

          <div class="mySlides fade">
            <div class="numbertext">5 / 5</div>
            <video width="100%" height="377" poster="keep.jpeg" controls>
              <source src="keep.mp4"  type="video/mp4">
              Your browser does not support HTML video.
            </video>
            <div class="text">Keep Calm And Besok Libur</div>
          </div>
      ...
      <div class="right">
        ...
        <br><br><br>
        <label><a href="Perang1.mp4" download= "Don Uji Nyali">
          Perang Lapangan Pertama

        </a><br><em>[18 Mei 2017]</em></label>
      ...
      <div style="position: relative; width: 600px; height: 800px;">
        ...
        <div style="position: absolute; bottom: 1px; border-top: solid; border-width: thin; width: 224.5%;">
